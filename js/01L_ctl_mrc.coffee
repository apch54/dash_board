...
# ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ *
    ...
    $$.titre_menu_base = () ->
        ...
        else if $$.rdio_dv in ['w','m']  then return $$.rdio_dv
...
#    init_date_2 = (d, but_r) -> todo retirer le 21-07
#    # d est une date sous forme de chaine
#    # but_r est le but renvoyé par la dernière requete SUCCESS
#        window.top.date_0 = $$.date_0 = $$.date_2 = new Date(d)
#
#        switch but_r
#            when 'dddr'
#                $$.maj_bd $$, $http, ajx_fl, 'initial_dp',d, d, 'p'  # premier chargement glob dp
#                # on informe les enfants
#                broadcast_lower() # emit graph pies & xy
#                $$.dates = d # affichage de la date
#
#            when 'initial_dp'   then $$.maj_bd $$, $http, ajx_fl, 'initial_w', d, d, 'w'  # premier chargement glob dp
#            when 'initial_w'    then $$.maj_bd $$, $http, ajx_fl, 'initial_m', d, d, 'm'  # premier chargement glob w
#            when 'initial_m'    then $$.maj_bd $$, $http, ajx_fl, 'Initial',   d, d, $$.rdio_dv    # premier chargement
#            when 'Initial'      then $$.maj_bd $$, $http, ajx_fl, 'gain_0',   d, d, $$.rdio_dv    # premier chargement
#            when 'gain_0'       then $$.get_bilan()
#            when 'bilan'        then $$.get_bd_variation($$.var_nbj)
#
    # ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ *
    # Handle dates
    # ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ ~ ¨¨¨¨¨¨¨¨¨¨¨¨ *
