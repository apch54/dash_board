  ...
  app.controller("ctl_mrc", function($scope, $document, $location, $anchorScroll, $http, $uibModal, $window, $log, $timeout, ngClipboard, $sce) {
    ...
    $$.maj_bd = function($$, $http, fle, v1, v2, v3, v4, $_then) {
      ...
      return $http.post(fle, {
        ...
        var $_then_x, but_r, e, k, len, ref, ref1, x;
    ...
    handle_bd_variation = function() {
      var cb1, error, i, i1, j1, k, k1, l, l1, len, len1, len2, len3, len4, len5, m1, n_var, o, q, ref, ref1, ref2, ref3, ref4, ref5, v, x, xid, xx, xx2, y, z;
      n_var = 9;
      try {
        ref = $$.bd_variation;
        for (k = 0, len = ref.length; k < len; k++) {
    ...
    get_bd_jeux_regies_campagnes = function() {
      var e, i1, j1, k, k1, l, l1, len, len1, len2, len3, len4, len5, len6, len7, len8, len9, m1, o, q, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, results, tc, tj, tr, v, y, z;
      try {
        $$.bd_jeux = [];
        tj = [];
        ref = $$.bd_glob;
        ...
        ref6 = $$.bd_glob;
        for (j1 = 0, len6 = ref6.length; j1 < len6; j1++) {
          t = ref6[j1];
          ref7 = ['WW, excluding live countries', 'Global', 'KITTY - FYBER'];
          for (k1 = 0, len7 = ref7.length; k1 < len7; k1++) {
            z = ref7[k1];
            if (t.Camp === z) {
              t.Camp = 'www';
            }
        ...
        results = [];
        for (m1 = 0, len9 = tc.length; m1 < len9; m1++) {
          z = tc[m1];
